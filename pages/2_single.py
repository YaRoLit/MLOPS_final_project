...
with col1:
    ...
    part = st.selectbox('Выберите район города', ('САО',
                                                  'ЛАО',
                                                  'КАО',
                                                  'ЦАО',
                                                  'ОАО'))
...
with col2:
    ...
    floor_range = st.number_input('Этажность дома', min_value=1, max_value=24)
...
if btn:
    ...
    st.write("Стоимость кв.м. жилья составляет:", float(predict.predict(test)))
