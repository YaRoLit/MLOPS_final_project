...
df_test = pd.DataFrame({'A': [1, 2, 1, 4, None, None, 7, 1, 9],
                        ...
                        'Столбец1': ['a', 'b', None, 'c', 'b', 'b', 'a', 'b', 'c'],
                        'дом': ['a', None, None, 'a', None, 'c', None, 'a', None]})


def test_fill_nans():
    '''Тестируем функцию заполнения пропусков'''
    
    df_nonans = pd.DataFrame({'A': [1.0, 2.0, 1.0, 4.0, 2.0, 2.0, 7.0, 1.0, 9.0],
                              'B': [7.0, 8.0, 7.0, 6.0, 7.0, 7.0, 7.0, 2.0, 1.0],
                              'Столбец1': ['a', 'b', 'b', 'c', 'b', 'b', 'a', 'b', 'c'],
                              'дом': ['a', 'a', 'a', 'a', 'a', 'c', 'a', 'a', 'a']})
...
def test_create_adress_feature():
    ...
    df_adress = pd.DataFrame({'A': [1.0, 2.0, 1.0, 4.0, 2.0, 2.0, 7.0, 1.0, 9.0],
                              'B': [7.0, 8.0, 7.0, 6.0, 7.0, 7.0, 7.0, 2.0, 1.0],
                              'Столбец1': ['a', 'b', 'b', 'c', 'b', 'b', 'a', 'b', 'c'],
                              'дом': ['a', 'a', 'a', 'a', 'a', 'c', 'a', 'a', 'a'],
                              'адрес': ['a, a', 'b, a', 'b, a', 'c, a', 'b, a', 'b, c', 'a, a', 'b, a', 'c, a']})
